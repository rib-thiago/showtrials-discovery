...
from lib.showtrials_paths import (  # noqa: E402
    DOCUMENT_TYPES_V3,
    DOCUMENT_TYPES_V3_VALIDATION,
    DOCUMENT_TYPES_V3_VALIDATION_REPORT,
    MASTER_CATALOG,
    ensure_parent,
)

DOCS = DOCUMENT_TYPES_V3
CATALOG = MASTER_CATALOG

REPORT = DOCUMENT_TYPES_V3_VALIDATION_REPORT
TSV = DOCUMENT_TYPES_V3_VALIDATION
