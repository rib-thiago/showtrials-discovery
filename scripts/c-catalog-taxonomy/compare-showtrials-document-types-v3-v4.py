...
from lib.showtrials_paths import (  # noqa: E402
    DOCUMENT_TYPES_V3,
    DOCUMENT_TYPES_V4,
    DOCUMENT_TYPE_V3_V4_CHANGES,
    DOCUMENT_TYPE_V3_V4_COMPARE_REPORT,
    ensure_parent,
)

OLD = DOCUMENT_TYPES_V3
NEW = DOCUMENT_TYPES_V4

OUT = DOCUMENT_TYPE_V3_V4_CHANGES
REPORT = DOCUMENT_TYPE_V3_V4_COMPARE_REPORT
