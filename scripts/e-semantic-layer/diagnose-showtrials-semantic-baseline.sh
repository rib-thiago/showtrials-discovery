...
REPORT="$BASE/showtrials_semantic_baseline_report.txt"
TSV="$BASE/showtrials_semantic_baseline_inventory.tsv"
DEPS="$BASE/showtrials_semantic_baseline_dependencies.tsv"
...
write_layer "catalog" "$BASE/showtrials_master_catalog.tsv"
write_layer "search_corpus" "$BASE/showtrials_search_corpus.tsv"
write_layer "people" "$BASE/showtrials_literal_people.tsv"
write_layer "person_documents" "$BASE/showtrials_literal_person_documents.tsv"
write_layer "person_aliases" "$BASE/showtrials_person_aliases.tsv"
write_layer "document_types_v4" "$BASE/showtrials_document_types_v4.tsv"
write_layer "organizations" "$BASE/showtrials_organizations.tsv"
write_layer "organization_documents" "$BASE/showtrials_organization_documents.tsv"
write_layer "organization_hierarchy" "$BASE/showtrials_organization_hierarchy.tsv"
write_layer "organization_families" "$BASE/showtrials_organization_families.tsv"
write_layer "organization_family_document_matrix" "$BASE/showtrials_organization_family_document_matrix.tsv"
write_layer "roles_v2" "$BASE/showtrials_roles_v2.tsv"
write_layer "role_documents_v2" "$BASE/showtrials_role_documents_v2.tsv"
write_layer "person_organization_matrix" "$BASE/showtrials_person_organization_matrix.tsv"
write_layer "person_organization_summary" "$BASE/showtrials_person_organization_summary.tsv"
write_layer "organization_person_summary" "$BASE/showtrials_organization_person_summary.tsv"
write_layer "person_context_profiles_v2" "$BASE/showtrials_person_institution_profiles_v2.tsv"
write_layer "processes" "$BASE/showtrials_processes.tsv"
write_layer "process_document_matrix" "$BASE/showtrials_process_document_matrix.tsv"
write_layer "person_process_matrix" "$BASE/showtrials_person_process_matrix.tsv"
write_layer "organization_process_matrix" "$BASE/showtrials_organization_process_matrix.tsv"
write_layer "family_process_matrix" "$BASE/showtrials_family_process_matrix.tsv"
write_layer "person_process_profiles" "$BASE/showtrials_person_process_profiles.tsv"
write_layer "organization_process_profiles" "$BASE/showtrials_organization_process_profiles.tsv"
write_layer "family_process_profiles" "$BASE/showtrials_family_process_profiles.tsv"
write_layer "search_v2_script" "$BASE/showtrials-search-v2.py"
write_layer "search_v2_validation" "$BASE/showtrials_search_v2_validation.tsv"
write_layer "semantic_layer_inventory" "$BASE/showtrials_semantic_layer_inventory.tsv"
write_layer "semantic_layer_validation" "$BASE/showtrials_semantic_layer_validation.tsv"
