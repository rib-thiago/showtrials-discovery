...
ENTITY_CLEANUP_REPORT = report_path("e", "showtrials_entity_cleanup_report.txt")
ENTITY_INVENTORY_REPORT = report_path("e", "showtrials_entity_inventory_report.txt")
ENTITY_ANOMALIES_REPORT = report_path("e", "showtrials_entity_anomalies_report.txt")
PERSON_ANOMALIES = data_path("e", "showtrials_person_anomalies.tsv")
TITLE_ENTITIES = data_path("e", "showtrials_title_entities.tsv")
TITLE_ENTITIES_REPORT = report_path("e", "showtrials_title_entities_report.txt")
...
PERSON_AUTO_ALIAS_REPORT = report_path("e", "showtrials_person_auto_alias_report.txt")
KNOWN_TRUNCATED_ALIASES_REPORT = report_path("e", "showtrials_known_truncated_aliases_report.txt")
...
PERSON_ORGANIZATION_MATRIX = data_path("e", "showtrials_person_organization_matrix.tsv")
PERSON_ORGANIZATION_MATRIX_REPORT = report_path("e", "showtrials_person_organization_matrix_report.txt")
PERSON_ORGANIZATION_MATRIX_VALIDATION = data_path("e", "showtrials_person_organization_matrix_validation.tsv")
PERSON_ORGANIZATION_MATRIX_VALIDATION_REPORT = report_path("e", "showtrials_person_organization_matrix_validation_report.txt")
ORGANIZATION_PERSON_SUMMARY = data_path("e", "showtrials_organization_person_summary.tsv")
PERSON_PROCESS_MATRIX = data_path("e", "showtrials_person_process_matrix.tsv")
PERSON_PROCESS_PROFILES = data_path("e", "showtrials_person_process_profiles.tsv")
PERSON_CENTRALITY = data_path("e", "showtrials_person_centrality.tsv")
PERSON_CENTRALITY_REPORT = report_path("e", "showtrials_person_centrality_report.txt")
PERSON_CENTRALITY_VALIDATION = data_path("e", "showtrials_person_centrality_validation.tsv")
PERSON_CENTRALITY_VALIDATION_REPORT = report_path("e", "showtrials_person_centrality_validation_report.txt")
PERSON_FAMILY_PAIRS = data_path("e", "showtrials_person_family_pairs.tsv")
PERSON_FAMILY_PAIRS_V2 = data_path("e", "showtrials_person_family_pairs_v2.tsv")
PERSON_ORGANIZATION_PROFILE_PAIRS = data_path("e", "showtrials_person_organization_profile_pairs.tsv")
PERSON_ORGANIZATION_PAIRS_V2 = data_path("e", "showtrials_person_organization_pairs_v2.tsv")
PERSON_POSITION_PROFILE_PAIRS = data_path("e", "showtrials_person_position_profile_pairs.tsv")
PERSON_ROLE_PAIRS_V2 = data_path("e", "showtrials_person_role_pairs_v2.tsv")
PERSON_INSTITUTION_PROFILES = data_path("e", "showtrials_person_institution_profiles.tsv")
PERSON_INSTITUTION_PROFILES_REPORT = report_path("e", "showtrials_person_institution_profiles_report.txt")
PERSON_INSTITUTION_PROFILES_V2 = data_path("e", "showtrials_person_institution_profiles_v2.tsv")
PERSON_INSTITUTION_PROFILES_V2_REPORT = report_path("e", "showtrials_person_institution_profiles_v2_report.txt")
PERSON_INSTITUTION_PROFILES_V2_VALIDATION = data_path("e", "showtrials_person_institution_profiles_v2_validation.tsv")
PERSON_INSTITUTION_PROFILES_V2_VALIDATION_REPORT = report_path("e", "showtrials_person_institution_profiles_v2_validation_report.txt")
POSITION_DOCUMENTS = data_path("e", "showtrials_position_documents.tsv")
POSITIONS = data_path("e", "showtrials_positions.tsv")
POSITIONS_REPORT = report_path("e", "showtrials_positions_report.txt")
PERSON_POSITION_PAIRS = data_path("e", "showtrials_person_position_pairs.tsv")
POSITION_ORGANIZATION_PAIRS = data_path("e", "showtrials_position_organization_pairs.tsv")
PROCESSES = data_path("e", "showtrials_processes.tsv")
PROCESS_DOCUMENT_MATRIX = data_path("e", "showtrials_process_document_matrix.tsv")
PROCESS_LAYER_REPORT = report_path("e", "showtrials_process_layer_report.txt")
PROCESS_LAYER_VALIDATION = data_path("e", "showtrials_process_layer_validation.tsv")
PROCESS_LAYER_VALIDATION_REPORT = report_path("e", "showtrials_process_layer_validation_report.txt")
PROCESS_PROFILES_REPORT = report_path("e", "showtrials_process_profiles_report.txt")
PROCESS_PROFILES_VALIDATION_REPORT = report_path("e", "showtrials_process_profiles_validation_report.txt")
ROLES_V2 = data_path("e", "showtrials_roles_v2.tsv")
ROLES_V2_REPORT = report_path("e", "showtrials_roles_v2_report.txt")
ROLES_V2_VALIDATION = data_path("e", "showtrials_roles_v2_validation.tsv")
ROLES_V2_VALIDATION_REPORT = report_path("e", "showtrials_roles_v2_validation_report.txt")
ROLE_DOCUMENTS_V2 = data_path("e", "showtrials_role_documents_v2.tsv")
ORGANIZATION_PROCESS_MATRIX = data_path("e", "showtrials_organization_process_matrix.tsv")
ORGANIZATION_PROCESS_PROFILES = data_path("e", "showtrials_organization_process_profiles.tsv")
FAMILY_PROCESS_MATRIX = data_path("e", "showtrials_family_process_matrix.tsv")
FAMILY_PROCESS_PROFILES = data_path("e", "showtrials_family_process_profiles.tsv")
SEMANTIC_LAYER_INVENTORY = data_path("e", "showtrials_semantic_layer_inventory.tsv")
SEMANTIC_LAYER_VALIDATION = data_path("e", "showtrials_semantic_layer_validation.tsv")
SEMANTIC_LAYER_REPORT = report_path("e", "showtrials_semantic_layer_report.txt")
SEMANTIC_BASELINE_INVENTORY = data_path("e", "showtrials_semantic_baseline_inventory.tsv")
SEMANTIC_BASELINE_DEPENDENCIES = data_path("e", "showtrials_semantic_baseline_dependencies.tsv")
SEMANTIC_BASELINE_REPORT = report_path("e", "showtrials_semantic_baseline_report.txt")
SEMANTIC_BASELINE_VALIDATION = data_path("e", "showtrials_semantic_baseline_validation.tsv")
SEMANTIC_BASELINE_VALIDATION_REPORT = report_path("e", "showtrials_semantic_baseline_validation_report.txt")
TAG_PROCESS_MATRIX = data_path("e", "showtrials_tag_process_matrix.tsv")
TAG_PROCESS_EXCLUSIVE = data_path("e", "showtrials_tag_process_exclusive.tsv")
TAG_PROCESS_AUDIT_REPORT = report_path("e", "showtrials_tag_process_audit_report.txt")
...
CORPUS_SIZING_BY_DOCUMENT_D1 = data_path("d", "showtrials_corpus_sizing_by_document_d1.tsv")
CORPUS_SIZING_BY_DOCUMENT_TYPE_D1 = data_path("d", "showtrials_corpus_sizing_by_document_type_d1.tsv")
CORPUS_SIZING_BY_PROCESS_D1 = data_path("d", "showtrials_corpus_sizing_by_process_d1.tsv")
CORPUS_SIZING_CHUNKING_D1_REPORT = report_path("d", "showtrials_corpus_sizing_chunking_d1_report.txt")
CORPUS_SIZING_CHUNKING_D1_VALIDATION = data_path("d", "showtrials_corpus_sizing_chunking_d1_validation.tsv")
CORPUS_SIZING_CHUNKING_D1_VALIDATION_REPORT = report_path("d", "showtrials_corpus_sizing_chunking_d1_validation_report.txt")
CHUNKING_POLICY_RECOMMENDATIONS_D1 = data_path("d", "showtrials_chunking_policy_recommendations_d1.tsv")

STRUCTURAL_CHUNKING_D2_BY_DOCUMENT = data_path("d", "showtrials_structural_chunking_d2_by_document.tsv")
STRUCTURAL_CHUNKING_D2_BY_TYPE = data_path("d", "showtrials_structural_chunking_d2_by_type.tsv")
STRUCTURAL_CHUNKING_D2_EXAMPLES = data_path("d", "showtrials_structural_chunking_d2_examples.tsv")
STRUCTURAL_CHUNKING_D2_REPORT = report_path("d", "showtrials_structural_chunking_d2_report.txt")
STRUCTURAL_CHUNKING_D2_VALIDATION = data_path("d", "showtrials_structural_chunking_d2_validation.tsv")
STRUCTURAL_CHUNKING_D2_VALIDATION_REPORT = report_path("d", "showtrials_structural_chunking_d2_validation_report.txt")
STRUCTURAL_SAMPLES_D2_1_DIR = data_path("d", "structural_samples_d2_1")
STRUCTURAL_SAMPLES_D2_1_INDEX = data_path("d", "showtrials_structural_samples_d2_1_index.tsv")
STRUCTURAL_SAMPLES_D2_1_REPORT = report_path("d", "showtrials_structural_samples_d2_1_report.txt")
STRUCTURAL_SAMPLES_D2_2_REVIEW_INDEX = data_path("d", "showtrials_structural_samples_d2_2_review_index.tsv")
STRUCTURAL_SAMPLES_D2_2_REPORT = report_path("d", "showtrials_structural_samples_d2_2_report.txt")

CHUNKING_BLUEPRINT_V1 = data_path("d", "showtrials_chunking_blueprint_v1.tsv")
CHUNKING_BLUEPRINT_V1_REPORT = report_path("d", "showtrials_chunking_blueprint_v1_report.txt")
CHUNKING_BLUEPRINT_V1_VALIDATION = data_path("d", "showtrials_chunking_blueprint_v1_validation.tsv")
CHUNKING_BLUEPRINT_V1_VALIDATION_REPORT = report_path("d", "showtrials_chunking_blueprint_v1_validation_report.txt")
CHUNKING_BLUEPRINT_V1_1 = data_path("d", "showtrials_chunking_blueprint_v1_1.tsv")
CHUNKING_BLUEPRINT_V1_1_REPORT = report_path("d", "showtrials_chunking_blueprint_v1_1_report.txt")
CHUNKING_BLUEPRINT_V1_1_VALIDATION = data_path("d", "showtrials_chunking_blueprint_v1_1_validation.tsv")
CHUNKING_BLUEPRINT_V1_1_VALIDATION_REPORT = report_path("d", "showtrials_chunking_blueprint_v1_1_validation_report.txt")
CHUNKING_POLICY_V1_1 = report_path("d", "showtrials_chunking_policy_v1_1.txt")

SPECIAL_REPORT_PACKAGES_D3_1 = data_path("d", "showtrials_special_report_packages_d3_1.tsv")
SPECIAL_REPORT_PACKAGE_SUMMARY_D3_1 = data_path("d", "showtrials_special_report_package_summary_d3_1.tsv")
SPECIAL_REPORT_PACKAGE_EXAMPLES_D3_1 = data_path("d", "showtrials_special_report_package_examples_d3_1.tsv")
SPECIAL_REPORT_PACKAGES_D3_1_REPORT = report_path("d", "showtrials_special_report_packages_d3_1_report.txt")
SPECIAL_REPORT_PACKAGES_D3_1_VALIDATION = data_path("d", "showtrials_special_report_packages_d3_1_validation.tsv")
SPECIAL_REPORT_PACKAGES_D3_1_VALIDATION_REPORT = report_path("d", "showtrials_special_report_packages_d3_1_validation_report.txt")

SPECIAL_REPORT_ATTACHMENT_MATRIX = data_path("d", "showtrials_special_report_attachment_matrix.tsv")
ATTACHMENT_TAXONOMY_D3_1A = data_path("d", "showtrials_attachment_taxonomy_d3_1a.tsv")
ATTACHMENT_TAXONOMY_CROSSWALK_D3_1A = data_path("d", "showtrials_attachment_taxonomy_crosswalk_d3_1a.tsv")
ATTACHMENT_TAXONOMY_D3_1A_REPORT = report_path("d", "showtrials_attachment_taxonomy_d3_1a_report.txt")
ATTACHMENT_TAXONOMY_D3_1A_VALIDATION = data_path("d", "showtrials_attachment_taxonomy_d3_1a_validation.tsv")
ATTACHMENT_TAXONOMY_D3_1A_VALIDATION_REPORT = report_path("d", "showtrials_attachment_taxonomy_d3_1a_validation_report.txt")
ATTACHMENT_TAXONOMY_D3_1B = data_path("d", "showtrials_attachment_taxonomy_d3_1b.tsv")
ATTACHMENT_TAXONOMY_REFINEMENT_D3_1B = data_path("d", "showtrials_attachment_taxonomy_refinement_d3_1b.tsv")
ATTACHMENT_TAXONOMY_REFINEMENT_D3_1B_REPORT = report_path("d", "showtrials_attachment_taxonomy_refinement_d3_1b_report.txt")
ATTACHMENT_TAXONOMY_REFINEMENT_D3_1B_VALIDATION = data_path("d", "showtrials_attachment_taxonomy_refinement_d3_1b_validation.tsv")
ATTACHMENT_TAXONOMY_REFINEMENT_D3_1B_VALIDATION_REPORT = report_path("d", "showtrials_attachment_taxonomy_refinement_d3_1b_validation_report.txt")
...
TRANSLATION_PROFILES_V1_1 = data_path("t", "showtrials_translation_profiles_v1_1.tsv")
